...
GetOptions(
    ...
    'fa=s'   => \$genomefile,
    'ref=s'  => \$gencodefile,
    'circ=s'     => \$resultcircfile,
    'as=s'       => \$resultasfile,
) or die "Error in command line arguments\n";

# Check if required arguments are provided
die "Usage: $0 --chimeric <file> --fa <file> --ref <file> --circ <file> --as <file>\n"
    unless $chimeric_file && $genomefile && $gencodefile && $resultcircfile && $resultasfile;

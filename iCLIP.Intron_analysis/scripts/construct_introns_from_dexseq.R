...
# opt$dexseq.targets = '../exon_preparations/DEXseq/dxrMutExons_up.filtered_differential.tsv'
# opt$genes = '../test_run/feature_db/dm6_ensembl96.genes.bed'
# opt$exons = '../test_run/feature_db/dm6_ensembl96.exons.bed'
# opt$introns = '../test_run/feature_db/dm6_ensembl96.introns.bed'
